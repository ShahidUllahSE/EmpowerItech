    ...
    <div className='container max-w-full bg-slate-800 text-white'>
      <div className='navbar flex justify-between items-center p-2'>
        ...
        <div className='hidden md:flex space-x-9 justify-items-center mr-80'>
          ...
          <Link to='/Team' className='hover:underline hover:underline-offset-8 hover:text-blue-500 cursor-pointer font-normal'> Team
          </Link>
          <Link to='/Gallery' className='hover:underline hover:underline-offset-8 hover:text-blue-500 cursor-pointer font-normal'> Gallery
          </Link>
          <Link to='/Services' className='hover:underline hover:underline-offset-8 hover:text-blue-500 cursor-pointer font-normal'> Services
          </Link>
          <Link to='/AboutUs' className='hover:underline hover:underline-offset-8 hover:text-blue-500 cursor-pointer font-normal'> About Us
          </Link>
          <Link to='/Contact' className='hover:underline hover:underline-offset-8 hover:text-blue-500 cursor-pointer font-normal'> Contact Us
          </Link>
        </div>
      </div>
    </div>
